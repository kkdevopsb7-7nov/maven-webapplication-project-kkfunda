...
//upstream and downstream job qa
   ...
   stages
   {
           stage('git checkout')
           {
              steps
              {
                 ...
                 git branch: 'qa', url: 'https://github.com/kkdevopsb7-7nov/maven-webapplication-project-kkfunda.git'
              }
           }
           stage('compile')
           {
...
"http://3.110.215.184:8080/manager/text/deploy?path=/maven-web-application&update=true"
        ...
        """
           ...
           stage('airtel-uat')
           {
              steps
              {
                   build job: 'airtel-uat'  //this downstrem job
              }
           }
